export const STORY = [
  ...
  },
  {
    ...
    kicker: "Get up",
    title: "Knock it over.\nIt stands back up.",
    body: "Back on the desk to standing, on its own, at 50 Hz. That is why it can live next to a laptop.",
  },
  {
    id: "cta",
    kicker: "Apache-2.0 software",
    title: "Train in sim.\nWaddle in reality.",
    body: "SDK, simulation, and the RL stack are on GitHub. Hardware files stay closed. Intro price $399.",
  },
] as const;
