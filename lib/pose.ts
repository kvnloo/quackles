...
export const POSES: Pose[] = [
  pose({
    ...
    crouch: 0.03,
    camPos: [0.5, 0.22, 1.08],
    lookAt: [0.05, 0.13, 0.02],
    fov: 32,
  }),
  pose({
    duckPosition: [0.02, 0.01, 0],
    duckRotation: [0, 0.4, 0],
    explode: 1,
    beak: 0.55,
    headPitch: 0.04,
    neckPitch: 0.12,
    camPos: [0.12, 0.36, 1.28],
    lookAt: [0, 0.14, 0],
    fov: 38,
  }),
  pose({
    duckPosition: [0.04, 0.02, 0],
    duckRotation: [-0.08, 0.55, 0.02],
    jump: 1,
    crouch: 0,
    beak: 0.1,
    headPitch: 0.14,
    neckPitch: 0.18,
    camPos: [0.48, 0.16, 1.02],
    lookAt: [0.04, 0.2, 0],
    fov: 34,
  }),
  pose({
