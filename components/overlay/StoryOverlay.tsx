  ...
  return (
    <div className="relative z-20">
      {STORY.map((section) => (
        <section
          key={section.id}
          className="relative flex min-h-[100svh] items-end md:items-center"
          aria-label={section.title.replace("\n", " ")}
        >
          <div className="w-full px-5 pb-28 pt-24 md:px-12 md:pb-24">
            <div className="max-w-xl md:max-w-[min(36rem,42vw)]">
...
$ robotctl update     # signed, reversible`}
                  ...
                  <p className="max-w-md text-[11px] leading-relaxed text-muted-foreground">
                    Fan-made 3D scrollytelling page. Microduck is a product of Pollen Robotics, the
                    Bordeaux robotics team at Hugging Face. Software is Apache-2.0; mechanical and
                    electronic design files are not open hardware. Facts from the{" "}
                    <a
