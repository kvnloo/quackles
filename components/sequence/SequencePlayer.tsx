...
export function SequencePlayer() {
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      const desiredWidth = Math.ceil(rect.width * Math.min(devicePixelRatio, 2) * crop.scale);
      ...
      for (const offset of [1, -1, 2, -2, 3, 4, 5, 6, 8]) {
  ...
  return <div ref={host} className="sequence-player" data-testid="sequence-player">
    <img ref={fallback} className="poster-plate" src={assetPath("/preview-scene/sequence/cinematic-proof-v2/day/p0000000-1024.webp")} width={1024} height={1536} alt="Microduck in the rendered studio" fetchPriority="high" />
